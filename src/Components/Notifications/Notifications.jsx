        ...
        <div>
          ...
          >
            ...
            <div className="pl-3 w-full">
              ...
              <div className="text-xs font-medium text-priMorgan Maddox-700 dark:text-priMorgan Maddox-400">
                a few moments ago
              </div>
            </div>
          </a>
          ...
          >
            ...
            <div className="pl-3 w-full">
              <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                ...
                <span className="font-medium text-priMorgan Maddox-700 dark:text-priMorgan Maddox-500">
                  @bonnie.green
                </span>
                what do you say?
              </div>
